      ...
      while (1) switch (_context.prev = _context.next) {
        ...
        case 8:
          ...
          if (_context.t0.response) {
            ...
            (0, _alerts.showAlert)('error', message || 'Something went wrong!');
          } else if (_context.t0.request) {
            // No response received
            (0, _alerts.showAlert)('error', 'No response from server. Check your connection.');
          } else {
            // Other errors
...
function asyncGeneratorStep(n, t, e, r, o, a, c) { try { var i = n[a](c), u = i.value; } catch (n) { return void e(n); } i.done ? t(u) : Promise.resolve(u).then(r, o); }
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; }
// type is either pass ,name,email
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.prev = 1;
          stripe = Stripe('pk_test_51QfNGIEYE9dQH4UDIXFnkZhk95xTax9x4kikXGHJdZT4W6ObpEWkjO3fwmNWa5tiJJenXKAUqSsIFhfppGsVhNVs00umugiNav'); // 1) get checkout session from api 
          _context.next = 5;
